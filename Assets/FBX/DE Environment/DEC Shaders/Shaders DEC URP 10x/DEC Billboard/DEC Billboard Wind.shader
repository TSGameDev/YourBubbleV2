	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				int WIND_MODE2462_g3282 = _WindMode;
				int m_switch2328_g3282 = WIND_MODE2462_g3282;
				...
				int m_switch2460_g3282 = WIND_MODE2462_g3282;
				...
				int m_switch2468_g3282 = WIND_MODE2462_g3282;
				...
				int m_switch2312_g3282 = WIND_MODE2462_g3282;
				...
				int m_switch2456_g3282 = WIND_MODE2462_g3282;
				...
				float3 temp_output_457_0_g43251 = localWind_Fadefloat3switch3050_g3282;
				...
				#endif
				float3 vertexValue = temp_output_457_0_g43251;
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						...
						, FRONT_FACE_TYPE ase_vface : FRONT_FACE_SEMANTIC ) : SV_Target
			{
				...
				float2 appendResult128_g43251 = (float2(_TilingX , _TilingY));
				float2 appendResult125_g43251 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43251 = IN.ase_texcoord7.xy * appendResult128_g43251 + appendResult125_g43251;
				float4 tex2DNode3_g43251 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, texCoord2_g43251 );
				float4 ALBEDO_RGBA529_g43251 = tex2DNode3_g43251;
				float3 temp_output_28_0_g43251 = ( (_Color).rgb * (ALBEDO_RGBA529_g43251).rgb * _Brightness );
				
				float4 NORMAL_PC_RGB531_g43251 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, texCoord2_g43251 );
				float4 temp_output_1_0_g43257 = NORMAL_PC_RGB531_g43251;
				float temp_output_8_0_g43257 = _NormalStrength;
				float3 unpack52_g43257 = UnpackNormalScale( temp_output_1_0_g43257, temp_output_8_0_g43257 );
				unpack52_g43257.z = lerp( 1, unpack52_g43257.z, saturate(temp_output_8_0_g43257) );
				float3 temp_output_604_59_g43251 = unpack52_g43257;
				float3 worldToViewDir560_g43251 = normalize( mul( UNITY_MATRIX_V, float4( SafeNormalize(_MainLightPosition.xyz), 0 ) ).xyz );
				float dotResult307_g43251 = dot( temp_output_604_59_g43251 , worldToViewDir560_g43251 );
				float3 appendResult306_g43251 = (float3(dotResult307_g43251 , dotResult307_g43251 , dotResult307_g43251));
				float3 NORMAL_IN42_g43252 = ( temp_output_604_59_g43251 + saturate( appendResult306_g43251 ) );
				int m_switch56_g43252 = _NormalMode;
				float3 m_Default56_g43252 = float3(1,1,1);
				float3 m_Flip56_g43252 = float3(-1,-1,-1);
				float3 m_Mirror56_g43252 = float3(1,1,-1);
				float3 local_NormalModefloat3switch56_g43252 = _NormalModefloat3switch( m_switch56_g43252 , m_Default56_g43252 , m_Flip56_g43252 , m_Mirror56_g43252 );
				float3 switchResult58_g43252 = (((ase_vface>0)?(NORMAL_IN42_g43252):(( NORMAL_IN42_g43252 * local_NormalModefloat3switch56_g43252 ))));
				int m_switch37_g43252 = _NormalMode;
				float3 m_Default37_g43252 = NORMAL_IN42_g43252;
				float3 m_Flip37_g43252 = ( NORMAL_IN42_g43252 * ase_vface );
				float3 break33_g43252 = NORMAL_IN42_g43252;
				float3 appendResult41_g43252 = (float3(break33_g43252.x , break33_g43252.y , ( break33_g43252.z * ase_vface )));
				float3 m_Mirror37_g43252 = appendResult41_g43252;
				float3 local_NormalModefloat3switch37_g43252 = _NormalModefloat3switch( m_switch37_g43252 , m_Default37_g43252 , m_Flip37_g43252 , m_Mirror37_g43252 );
				float3 temp_output_620_30_g43251 = local_NormalModefloat3switch37_g43252;
				float3 NORMAL_OUT575_g43251 = temp_output_620_30_g43251;
				float3 temp_output_16_0_g43266 = NORMAL_OUT575_g43251;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal134_g43266 = temp_output_16_0_g43266;
				float3 worldNormal134_g43266 = float3(dot(tanToWorld0,tanNormal134_g43266), dot(tanToWorld1,tanNormal134_g43266), dot(tanToWorld2,tanNormal134_g43266));
				float3 NORMAL_TANGENTSPACE135_g43266 = worldNormal134_g43266;
				float3 WorldPosition63_g43266 = NORMAL_TANGENTSPACE135_g43266;
				float4 shadowMaskValue77_g43266 = float4(1,1,1,1);
				float4 ShadowMask63_g43266 = shadowMaskValue77_g43266;
				float3 localAdditionalLightsFlatMask63_g43266 = AdditionalLightsFlatMask( WorldPosition63_g43266 , ShadowMask63_g43266 );
				float3 ADDITIONAL_LIGHT567_g43251 = localAdditionalLightsFlatMask63_g43266;
				
				float temp_output_1_0_g43264 = _MetallicStrength;
				
				float temp_output_660_0_g43251 = (_SmoothnessMin + (0.0 - 0.0) * (_SmoothnessMax - _SmoothnessMin) / (1.0 - 0.0));
				
				float temp_output_16_0_g43259 = _OcclusionStrengthAO;
				float4 temp_cast_3 = (( 1.0 - temp_output_16_0_g43259 )).xxxx;
				float4 color77_g43259 = IsGammaSpace() ? float4(1,1,1,1) : float4(1,1,1,1);
				float4 temp_cast_4 = (IN.ase_color.a).xxxx;
				float4 lerpResult75_g43259 = lerp( color77_g43259 , temp_cast_4 , temp_output_16_0_g43259);
				float4 lerpResult83_g43259 = lerp( temp_cast_3 , lerpResult75_g43259 , _OcclusionSource);
				
				float ALBEDO_A414_g43251 = tex2DNode3_g43251.a;
				float Albedo_Alpha52_g43258 = ALBEDO_A414_g43251;
				float3 normalizeResult38_g43258 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
				float dotResult35_g43258 = dot( normalizeResult38_g43258 , WorldViewDirection );
				float temp_output_32_0_g43258 = ( 1.0 - abs( dotResult35_g43258 ) );
				float lerpResult67_g43258 = lerp( 1.0 , ( 1.0 - ( temp_output_32_0_g43258 * temp_output_32_0_g43258 ) ) , _GlancingClipMode1);
				float OpacityMask42_g43258 = lerpResult67_g43258;
				
				float AlphaCutoffBias33_g43258 = _AlphaCutoffBias;
				
				float3 Albedo = ( float4( temp_output_28_0_g43251 , 0.0 ) + float4(0,0,0,0) ).xyz;
				float3 Normal = ( switchResult58_g43252 + ADDITIONAL_LIGHT567_g43251 );
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = temp_output_1_0_g43264;
				float Smoothness = temp_output_660_0_g43251;
				float Occlusion = saturate( lerpResult83_g43259 ).r;
				float Alpha = ( Albedo_Alpha52_g43258 * OpacityMask42_g43258 );
				float AlphaClipThreshold = AlphaCutoffBias33_g43258;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult128_g43251 = (float2(_TilingX , _TilingY));
				float2 appendResult125_g43251 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43251 = IN.ase_texcoord2.xy * appendResult128_g43251 + appendResult125_g43251;
				float4 tex2DNode3_g43251 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, texCoord2_g43251 );
				float ALBEDO_A414_g43251 = tex2DNode3_g43251.a;
				float Albedo_Alpha52_g43258 = ALBEDO_A414_g43251;
				float3 normalizeResult38_g43258 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
				...
				float dotResult35_g43258 = dot( normalizeResult38_g43258 , ase_worldViewDir );
				float temp_output_32_0_g43258 = ( 1.0 - abs( dotResult35_g43258 ) );
				float lerpResult67_g43258 = lerp( 1.0 , ( 1.0 - ( temp_output_32_0_g43258 * temp_output_32_0_g43258 ) ) , _GlancingClipMode1);
				float OpacityMask42_g43258 = lerpResult67_g43258;
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult128_g43251 = (float2(_TilingX , _TilingY));
				float2 appendResult125_g43251 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43251 = IN.ase_texcoord3.xy * appendResult128_g43251 + appendResult125_g43251;
				float4 tex2DNode3_g43251 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, texCoord2_g43251 );
				float ALBEDO_A414_g43251 = tex2DNode3_g43251.a;
				float Albedo_Alpha52_g43258 = ALBEDO_A414_g43251;
				float3 normalizeResult38_g43258 = normalize( cross( ddx( WorldPosition ) , ddy( WorldPosition ) ) );
...
/*ASEBEGIN
Version=18923
97;102.5;1730;798;690.4058;284.7532;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;455;68.24001,-27.66832;Inherit;False;328.6918;357.9233;GLOBAL SETTINGS ;2;438;463;;0,0,0,1;0;0
Node;AmplifyShaderEditor.FunctionNode;447;-658.5287,337.7452;Inherit;False;DESF Module Wind;80;;3282;b135a554f7e4d0b41bba02c61b34ae74;11,2881,0,938,0,2457,2,2432,2,2434,2,2433,2,2371,2,2454,2,2752,0,2995,0,2878,0;0;2;FLOAT3;2190;FLOAT4;2970
Node;AmplifyShaderEditor.IntNode;438;90.65547,10.81754;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
...
Node;AmplifyShaderEditor.FunctionNode;463;95.34424,112.2468;Inherit;False;DESF URP GUI 10x Surface Options;4;;43272;06c8ac62791f7a845bbafd8ecdb1912b;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;448;-443.8281,336.7457;Inherit;False;DESF Core Billboard;9;;43251;e3fce2294f3bde941a48e407ffdf732f;14,139,2,572,2,582,1,626,0,625,0,668,0,639,0,638,0,69,0,540,0,361,0,613,0,541,0,612,0;2;457;FLOAT3;0,0,0;False;454;FLOAT4;0,0,0,0;False;9;FLOAT4;0;FLOAT3;556;FLOAT;56;FLOAT;50;COLOR;57;FLOAT;49;FLOAT;351;FLOAT;649;FLOAT3;458
...
Node;AmplifyShaderEditor.FunctionNode;450;77.4069,680.9952;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43250;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=2CEE289AF4F411C5568017A2DFAE80EBE2E756B0