...
Shader "DEC/Surface/Surface Height Detail Tessellation"
{
	Properties
	{
		...
		[Header(DISPLACEMENT)][Enum(Off,0,Active,1,Active Reconstructed,2)]_DisplacementReconstructMode("Mode", Int) = 0
	...
	SubShader
	{
		...
		Pass
		{
			...
			int _DisplacementReconstructMode;
			float _TilingX;
			float _TilingY;
			float _OffsetX;
			float _OffsetY;
			...
			float3 _Displacement_ModeCfloat3switch( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveReconstructed )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float4 Detail_Maskfloat4switch226_g43207( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float Detail_BlendVCfloatswitch319_g43207( int m_switch, float m_Red, float m_Green, float m_Blue )
			{
				if(m_switch ==0)
					return m_Red;
				else if(m_switch ==1)
			...
			void CalculateUVsSmooth19_g43127( float2 UV, float4 TexelSize, out float2 UV0, out float2 UV1, out float2 UV2, out float2 UV3, out float2 UV4, out float2 UV5, out float2 UV6, out float2 UV7, out float2 UV8 )
			{
				{
			...
			float3 CombineSamplesSmooth31_g43127( float Strength, float S0, float S1, float S2, float S3, float S4, float S5, float S6, float S7, float S8 )
			{
				{
				 float3 normal;
			...
			float3 Detail_Maskfloat3switch221_g43207( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				int temp_output_62_0_g43134 = _DisplacementReconstructMode;
				int m_switch74_g43134 = temp_output_62_0_g43134;
				float3 _Vector3 = float3(0,0,0);
				float3 m_Off74_g43134 = _Vector3;
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43136 = v.texcoord.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 OUT_UV431_g38539 = texCoord2_g43136;
				float2 UV40_g43133 = OUT_UV431_g38539;
				float4 OUT_DISPLAC1180_g38539 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g43133, 0.0 );
				float3 temp_output_190_0_g43134 = (OUT_DISPLAC1180_g38539).xyz;
				float temp_output_61_0_g43134 = _DisplacementReconstructStrength;
				float3 temp_output_200_0_g43134 = ( v.ase_normal * ( temp_output_190_0_g43134 * temp_output_61_0_g43134 ) );
				float3 m_Active74_g43134 = temp_output_200_0_g43134;
				float3 m_ActiveReconstructed74_g43134 = temp_output_200_0_g43134;
				float3 local_Displacement_ModeCfloat3switch74_g43134 = _Displacement_ModeCfloat3switch( m_switch74_g43134 , m_Off74_g43134 , m_Active74_g43134 , m_ActiveReconstructed74_g43134 );
				...
				#endif
				float3 vertexValue = ( temp_output_309_0_g38539 + local_Displacement_ModeCfloat3switch74_g43134 );
				#ifdef ASE_ABSOLUTE_VERTEX_POS
						 ...
						 ) : SV_Target
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43136 = IN.ase_texcoord7.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 OUT_UV431_g38539 = texCoord2_g43136;
				float2 UV40_g43133 = OUT_UV431_g38539;
				float4 tex2DNode63_g43133 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g43133 );
				float4 OUT_ALBEDO_RGBA1177_g38539 = tex2DNode63_g43133;
				float3 temp_output_7_0_g38539 = ( (_Color).rgb * (OUT_ALBEDO_RGBA1177_g38539).rgb * _Brightness );
				float4 temp_output_39_0_g43207 = ( float4( temp_output_7_0_g38539 , 0.0 ) + float4(0,0,0,0) );
				float4 Albedo_RGBA40_g43207 = temp_output_39_0_g43207;
				int m_switch226_g43207 = _EnableDetailMask;
				float2 appendResult132_g43207 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43207 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43207 = IN.ase_texcoord7.xy * appendResult132_g43207 + appendResult114_g43207;
				float4 tex2DNode45_g43207 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g43207 );
				float4 ALBEDO_OUT255_g43207 = ( _ColorDetail * tex2DNode45_g43207 * _Brightness );
				float4 m_Off226_g43207 = ALBEDO_OUT255_g43207;
				float2 appendResult219_g43207 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43207 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43207 = IN.ase_texcoord7.xy * appendResult219_g43207 + appendResult206_g43207;
				float temp_output_15_0_g43210 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g43207 ).r );
				float temp_output_26_0_g43210 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43210 = _Detail_BlendHardnessMask;
				float saferPower2_g43210 = abs( max( saturate( (0.0 + (temp_output_15_0_g43210 - ( 1.0 - temp_output_26_0_g43210 )) * (temp_output_24_0_g43210 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43210 ))) ) , 0.0 ) );
				float temp_output_22_0_g43210 = _Detail_BlendFalloffMask;
				float temp_output_403_0_g43207 = saturate( pow( saferPower2_g43210 , ( 1.0 - temp_output_22_0_g43210 ) ) );
				float4 lerpResult225_g43207 = lerp( Albedo_RGBA40_g43207 , ALBEDO_OUT255_g43207 , temp_output_403_0_g43207);
				float4 m_Active226_g43207 = lerpResult225_g43207;
				float saferPower11_g43210 = abs( max( saturate( (1.0 + (temp_output_15_0_g43210 - temp_output_26_0_g43210) * (( 1.0 - temp_output_24_0_g43210 ) - 1.0) / (0.0 - temp_output_26_0_g43210)) ) , 0.0 ) );
				float temp_output_403_21_g43207 = saturate( pow( saferPower11_g43210 , temp_output_22_0_g43210 ) );
				float4 lerpResult408_g43207 = lerp( ALBEDO_OUT255_g43207 , Albedo_RGBA40_g43207 , temp_output_403_21_g43207);
				float4 m_ActiveInverted226_g43207 = lerpResult408_g43207;
				float4 localDetail_Maskfloat4switch226_g43207 = Detail_Maskfloat4switch226_g43207( m_switch226_g43207 , m_Off226_g43207 , m_Active226_g43207 , m_ActiveInverted226_g43207 );
				float4 Mask_Albedo258_g43207 = localDetail_Maskfloat4switch226_g43207;
				float4 break48_g43207 = temp_output_39_0_g43207;
				float Albedo_RGB300_g43207 = ( break48_g43207.x + break48_g43207.y + break48_g43207.z );
				int m_switch319_g43207 = _BlendColor;
				float m_Red319_g43207 = IN.ase_color.r;
				float m_Green319_g43207 = IN.ase_color.g;
				float m_Blue319_g43207 = IN.ase_color.b;
				float localDetail_BlendVCfloatswitch319_g43207 = Detail_BlendVCfloatswitch319_g43207( m_switch319_g43207 , m_Red319_g43207 , m_Green319_g43207 , m_Blue319_g43207 );
				float clampResult47_g43207 = clamp( ( ( ( ( Albedo_RGB300_g43207 - 0.5 ) * ( _DetailBlendInfluence - 0.9 ) ) + ( localDetail_BlendVCfloatswitch319_g43207 - ( _BlendHeight - 0.4 ) ) ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float DetailBlend43_g43207 = clampResult47_g43207;
				float4 lerpResult58_g43207 = lerp( Mask_Albedo258_g43207 , Albedo_RGBA40_g43207 , DetailBlend43_g43207);
				float4 lerpResult409_g43207 = lerp( Albedo_RGBA40_g43207 , lerpResult58_g43207 , _EnableDetailMap);
				
				int _Displacement_Mode1309_g38539 = _DisplacementReconstructMode;
				int m_switch1310_g38539 = _Displacement_Mode1309_g38539;
				float4 OUT_NORMAL1178_g38539 = SAMPLE_TEXTURE2D( _BumpMap, sampler_trilinear_repeat, UV40_g43133 );
				float4 temp_output_1_0_g43120 = OUT_NORMAL1178_g38539;
				...
				float3 temp_output_1478_59_g38539 = unpack52_g43120;
				...
				float temp_output_29_0_g43127 = temp_output_1334_0_g38539;
				float Strength31_g43127 = temp_output_29_0_g43127;
				float localCalculateUVsSmooth19_g43127 = ( 0.0 );
				float2 temp_output_96_0_g43127 = OUT_UV431_g38539;
				float2 UV19_g43127 = temp_output_96_0_g43127;
				float4 TexelSize19_g43127 = _ParallaxMap_TexelSize;
				float2 UV019_g43127 = float2( 0,0 );
				float2 UV119_g43127 = float2( 0,0 );
				float2 UV219_g43127 = float2( 0,0 );
				float2 UV319_g43127 = float2( 0,0 );
				float2 UV419_g43127 = float2( 0,0 );
				float2 UV519_g43127 = float2( 0,0 );
				float2 UV619_g43127 = float2( 0,0 );
				float2 UV719_g43127 = float2( 0,0 );
				float2 UV819_g43127 = float2( 0,0 );
				CalculateUVsSmooth19_g43127( UV19_g43127 , TexelSize19_g43127 , UV019_g43127 , UV119_g43127 , UV219_g43127 , UV319_g43127 , UV419_g43127 , UV519_g43127 , UV619_g43127 , UV719_g43127 , UV819_g43127 );
				float4 break13_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV019_g43127 );
				float S031_g43127 = break13_g43127.r;
				float4 break8_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV119_g43127 );
				float S131_g43127 = break8_g43127.r;
				float4 break5_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV219_g43127 );
				float S231_g43127 = break5_g43127.r;
				float4 break3_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV319_g43127 );
				float S331_g43127 = break3_g43127.r;
				float4 break12_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV419_g43127 );
				float S431_g43127 = break12_g43127.r;
				float4 break23_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV519_g43127 );
				float S531_g43127 = break23_g43127.r;
				float4 break44_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV619_g43127 );
				float S631_g43127 = break44_g43127.r;
				float4 break42_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV719_g43127 );
				float S731_g43127 = break42_g43127.r;
				float4 break40_g43127 = SAMPLE_TEXTURE2D( _ParallaxMap, sampler_trilinear_repeat, UV819_g43127 );
				float S831_g43127 = break40_g43127.r;
				float3 localCombineSamplesSmooth31_g43127 = CombineSamplesSmooth31_g43127( Strength31_g43127 , S031_g43127 , S131_g43127 , S231_g43127 , S331_g43127 , S431_g43127 , S531_g43127 , S631_g43127 , S731_g43127 , S831_g43127 );
				float3 m_ActiveReconstructed1310_g38539 = localCombineSamplesSmooth31_g43127;
				...
				float3 temp_output_16_0_g43131 = NORMAL_OUT314_g38539;
				...
				float3 ADDITIONAL_LIGHT1342_g38539 = localAdditionalLightsFlatMask63_g43131;
				float3 temp_output_38_0_g43207 = ( local_Displacement_ModeCfloat3switch1310_g38539 + ADDITIONAL_LIGHT1342_g38539 );
				float3 Normal_XYZ260_g43207 = temp_output_38_0_g43207;
				int EnableDetailMask216_g43207 = _EnableDetailMask;
				int m_switch221_g43207 = EnableDetailMask216_g43207;
				float4 temp_output_1_0_g43208 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat, texCoord67_g43207 );
				float temp_output_8_0_g43208 = _DetailNormalMapScale;
				float3 unpack52_g43208 = UnpackNormalScale( temp_output_1_0_g43208, temp_output_8_0_g43208 );
				unpack52_g43208.z = lerp( 1, unpack52_g43208.z, saturate(temp_output_8_0_g43208) );
				float3 Detail_Normal199_g43207 = unpack52_g43208;
				float3 m_Off221_g43207 = Detail_Normal199_g43207;
				float3 lerpResult205_g43207 = lerp( Normal_XYZ260_g43207 , Detail_Normal199_g43207 , temp_output_403_0_g43207);
				float3 m_Active221_g43207 = saturate( lerpResult205_g43207 );
				float3 lerpResult406_g43207 = lerp( Detail_Normal199_g43207 , Normal_XYZ260_g43207 , temp_output_403_21_g43207);
				float3 m_ActiveInverted221_g43207 = saturate( lerpResult406_g43207 );
				float3 localDetail_Maskfloat3switch221_g43207 = Detail_Maskfloat3switch221_g43207( m_switch221_g43207 , m_Off221_g43207 , m_Active221_g43207 , m_ActiveInverted221_g43207 );
				float3 Mask_Normal222_g43207 = localDetail_Maskfloat3switch221_g43207;
				float layeredBlendVar413_g43207 = DetailBlend43_g43207;
				float3 layeredBlend413_g43207 = ( lerp( Mask_Normal222_g43207,Normal_XYZ260_g43207 , layeredBlendVar413_g43207 ) );
				float3 normalizeResult414_g43207 = normalize( layeredBlend413_g43207 );
				float3 temp_output_416_0_g43207 = BlendNormal( normalizeResult414_g43207 , Normal_XYZ260_g43207 );
				float EnebleMode122_g43207 = _EnableDetailMap;
				float3 lerpResult410_g43207 = lerp( Normal_XYZ260_g43207 , temp_output_416_0_g43207 , EnebleMode122_g43207);
				
				float4 _MASK_B1440_g38539 = SAMPLE_TEXTURE2D( _MetallicGlossMap, sampler_trilinear_repeat, UV40_g43133 );
				...
				float4 _MASK_G1438_g38539 = SAMPLE_TEXTURE2D( _SmoothnessMap, sampler_trilinear_repeat, UV40_g43133 );
				float4 temp_cast_10 = (_SmoothnessMin).xxxx;
				float4 temp_cast_11 = (_SmoothnessMax).xxxx;
				float4 temp_output_216_0_g43132 = (temp_cast_10 + (_MASK_G1438_g38539 - float4( 0,0,0,0 )) * (temp_cast_11 - temp_cast_10) / (float4( 1,1,1,1 ) - float4( 0,0,0,0 )));
				...
				float3 tanNormal67_g43120 = unpack52_g43120;
				float3 worldNormal67_g43120 = float3(dot(tanToWorld0,tanNormal67_g43120), dot(tanToWorld1,tanNormal67_g43120), dot(tanToWorld2,tanNormal67_g43120));
				float3 temp_output_1478_66_g38539 = worldNormal67_g43120;
				...
				float3 tangentToWorldDir104_g43127 = mul( ase_tangentToWorldFast, localCombineSamplesSmooth31_g43127 );
				float3 m_ActiveReconstructed1387_g38539 = tangentToWorldDir104_g43127;
				...
				float3 temp_output_4_0_g43132 = NORMAL_WORLD_OUT164_g38539;
				...
				float4 temp_output_1556_33_g38539 = localSmoothnessTypefloat4switch215_g43132;
				float4 PBR_Occlusion1641_g38539 = SAMPLE_TEXTURE2D( _OcclusionMap, sampler_trilinear_repeat, UV40_g43133 );
				...
				float4 lerpResult83_g43125 = lerp( float4( ( ( ( (PBR_Occlusion1641_g38539).xyz - float3( 0.5,0.5,0.5 ) ) * temp_output_16_0_g43125 ) + appendResult69_g43125 ) , 0.0 ) , lerpResult75_g43125 , _OcclusionSource);
				float4 Occlusion1550_g38539 = saturate( lerpResult83_g43125 );
				
				float3 Albedo = lerpResult409_g43207.xyz;
				float3 Normal = lerpResult410_g43207;
				float3 Emission = 0;
				float3 Specular = 0.5;
				float Metallic = ( _MASK_B1440_g38539.r * temp_output_1_0_g43124 );
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v )
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43136 = v.ase_texcoord.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 OUT_UV431_g38539 = texCoord2_g43136;
				float2 UV40_g43133 = OUT_UV431_g38539;
				float4 OUT_DISPLAC1180_g38539 = SAMPLE_TEXTURE2D_LOD( _ParallaxMap, sampler_trilinear_repeat, UV40_g43133, 0.0 );
				float3 temp_output_190_0_g43134 = (OUT_DISPLAC1180_g38539).xyz;
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43136 = IN.ase_texcoord2.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 OUT_UV431_g38539 = texCoord2_g43136;
				float2 UV40_g43133 = OUT_UV431_g38539;
				float4 tex2DNode63_g43133 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g43133 );
				float4 OUT_ALBEDO_RGBA1177_g38539 = tex2DNode63_g43133;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult132_g43207 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43207 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43207 = IN.ase_texcoord2.xy * appendResult132_g43207 + appendResult114_g43207;
				float4 tex2DNode45_g43207 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g43207 );
				float4 ALBEDO_OUT255_g43207 = ( _ColorDetail * tex2DNode45_g43207 * _Brightness );
				float4 m_Off226_g43207 = ALBEDO_OUT255_g43207;
				float2 appendResult219_g43207 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43207 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43207 = IN.ase_texcoord2.xy * appendResult219_g43207 + appendResult206_g43207;
				float temp_output_15_0_g43210 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g43207 ).r );
				float temp_output_26_0_g43210 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43210 = _Detail_BlendHardnessMask;
				float saferPower2_g43210 = abs( max( saturate( (0.0 + (temp_output_15_0_g43210 - ( 1.0 - temp_output_26_0_g43210 )) * (temp_output_24_0_g43210 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43210 ))) ) , 0.0 ) );
		...
		Pass
		{
						 ...
						 ) : SV_TARGET
			{
				...
				float2 appendResult150_g38539 = (float2(_TilingX , _TilingY));
				float2 appendResult151_g38539 = (float2(_OffsetX , _OffsetY));
				float2 texCoord2_g43136 = IN.ase_texcoord3.xy * appendResult150_g38539 + appendResult151_g38539;
				float2 OUT_UV431_g38539 = texCoord2_g43136;
				float2 UV40_g43133 = OUT_UV431_g38539;
				float4 tex2DNode63_g43133 = SAMPLE_TEXTURE2D( _MainTex, sampler_trilinear_repeat, UV40_g43133 );
				float4 OUT_ALBEDO_RGBA1177_g38539 = tex2DNode63_g43133;
...
/*ASEBEGIN
Version=18923
97;102.5;1730;798;-433.2456;1293.238;1;True;False
...
Node;AmplifyShaderEditor.FunctionNode;396;701.1121,-686.88;Inherit;False;DESF Core Surface;9;;38539;c3df20d62907cd04086a1eacc41e29d1;18,1352,2,183,2,1382,1,1433,1,1432,1,1434,1,1638,0,1491,0,1588,0,1284,0,1446,0,1319,1,249,1,1318,1,1443,0,1337,0,1336,0,1407,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;8;FLOAT4;42;FLOAT3;39;FLOAT;0;FLOAT4;41;COLOR;43;FLOAT;55;FLOAT;1624;FLOAT3;313
Node;AmplifyShaderEditor.RangedFloatNode;386;1098.215,-1024.085;Half;False;Property;_TessellationStrength;Tessellation Strength;63;0;Create;False;1;;0;0;True;1;Header(TESSELLATION URP);False;6;0.5;0.001;100;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;387;1098.714,-954.8705;Half;False;Property;_TessellationDistanceMin;Tessellation Distance Min;65;0;Create;False;1;;0;0;True;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;395;1391.743,-336.798;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43211;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;385;1099.53,-884.6912;Half;False;Property;_TessellationDistanceMax;Tessellation Distance Max ;66;0;Create;False;1;;0;0;True;0;False;5;2000;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.IntNode;379;1414.366,-1025.99;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.RangedFloatNode;388;1097.701,-815.3647;Half;False;Property;_TessellationPhong;Tessellation Phong;64;0;Create;False;1;;0;0;True;0;False;0.5;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;393;1153.659,-681.048;Inherit;False;DESF Module Detail;67;;43207;49c077198be2bdb409ab6ad879c0ca28;4,201,1,200,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.FunctionNode;410;1414.995,-949.2378;Inherit;False;DESF URP GUI 10x Surface Options;4;;43206;06c8ac62791f7a845bbafd8ecdb1912b;0;0;1;FLOAT;0
...
WireConnection;374;16;396;1624
WireConnection;374;8;396;313
ASEEND*/
//CHKSM=D5307555172EAB77C28795B5413B1E3E091ED0B0