...
Shader "DEC/Surface/Surface Detail"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Detail_Maskfloat4switch226_g43202( int m_switch, float4 m_Off, float4 m_Active, float4 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
			...
			float Detail_BlendVCfloatswitch319_g43202( int m_switch, float m_Red, float m_Green, float m_Blue )
			{
				if(m_switch ==0)
					return m_Red;
				else if(m_switch ==1)
			...
			float3 Detail_Maskfloat3switch221_g43202( int m_switch, float3 m_Off, float3 m_Active, float3 m_ActiveInverted )
			{
				if(m_switch ==0)
					return m_Off;
				else if(m_switch ==1)
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_39_0_g43202 = ( float4( temp_output_7_0_g38532 , 0.0 ) + float4(0,0,0,0) );
				float4 Albedo_RGBA40_g43202 = temp_output_39_0_g43202;
				int m_switch226_g43202 = _EnableDetailMask;
				float2 appendResult132_g43202 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43202 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43202 = IN.ase_texcoord7.xy * appendResult132_g43202 + appendResult114_g43202;
				float4 tex2DNode45_g43202 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g43202 );
				float4 ALBEDO_OUT255_g43202 = ( _ColorDetail * tex2DNode45_g43202 * _Brightness );
				float4 m_Off226_g43202 = ALBEDO_OUT255_g43202;
				float2 appendResult219_g43202 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43202 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43202 = IN.ase_texcoord7.xy * appendResult219_g43202 + appendResult206_g43202;
				float temp_output_15_0_g43205 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g43202 ).r );
				float temp_output_26_0_g43205 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43205 = _Detail_BlendHardnessMask;
				float saferPower2_g43205 = abs( max( saturate( (0.0 + (temp_output_15_0_g43205 - ( 1.0 - temp_output_26_0_g43205 )) * (temp_output_24_0_g43205 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43205 ))) ) , 0.0 ) );
				float temp_output_22_0_g43205 = _Detail_BlendFalloffMask;
				float temp_output_403_0_g43202 = saturate( pow( saferPower2_g43205 , ( 1.0 - temp_output_22_0_g43205 ) ) );
				float4 lerpResult225_g43202 = lerp( Albedo_RGBA40_g43202 , ALBEDO_OUT255_g43202 , temp_output_403_0_g43202);
				float4 m_Active226_g43202 = lerpResult225_g43202;
				float saferPower11_g43205 = abs( max( saturate( (1.0 + (temp_output_15_0_g43205 - temp_output_26_0_g43205) * (( 1.0 - temp_output_24_0_g43205 ) - 1.0) / (0.0 - temp_output_26_0_g43205)) ) , 0.0 ) );
				float temp_output_403_21_g43202 = saturate( pow( saferPower11_g43205 , temp_output_22_0_g43205 ) );
				float4 lerpResult408_g43202 = lerp( ALBEDO_OUT255_g43202 , Albedo_RGBA40_g43202 , temp_output_403_21_g43202);
				float4 m_ActiveInverted226_g43202 = lerpResult408_g43202;
				float4 localDetail_Maskfloat4switch226_g43202 = Detail_Maskfloat4switch226_g43202( m_switch226_g43202 , m_Off226_g43202 , m_Active226_g43202 , m_ActiveInverted226_g43202 );
				float4 Mask_Albedo258_g43202 = localDetail_Maskfloat4switch226_g43202;
				float4 break48_g43202 = temp_output_39_0_g43202;
				float Albedo_RGB300_g43202 = ( break48_g43202.x + break48_g43202.y + break48_g43202.z );
				int m_switch319_g43202 = _BlendColor;
				float m_Red319_g43202 = IN.ase_color.r;
				float m_Green319_g43202 = IN.ase_color.g;
				float m_Blue319_g43202 = IN.ase_color.b;
				float localDetail_BlendVCfloatswitch319_g43202 = Detail_BlendVCfloatswitch319_g43202( m_switch319_g43202 , m_Red319_g43202 , m_Green319_g43202 , m_Blue319_g43202 );
				float clampResult47_g43202 = clamp( ( ( ( ( Albedo_RGB300_g43202 - 0.5 ) * ( _DetailBlendInfluence - 0.9 ) ) + ( localDetail_BlendVCfloatswitch319_g43202 - ( _BlendHeight - 0.4 ) ) ) / _DetailBlendSmooth ) , 0.0 , 1.0 );
				float DetailBlend43_g43202 = clampResult47_g43202;
				float4 lerpResult58_g43202 = lerp( Mask_Albedo258_g43202 , Albedo_RGBA40_g43202 , DetailBlend43_g43202);
				float4 lerpResult409_g43202 = lerp( Albedo_RGBA40_g43202 , lerpResult58_g43202 , _EnableDetailMap);
				...
				float3 temp_output_38_0_g43202 = ( temp_output_1478_59_g38532 + ADDITIONAL_LIGHT1342_g38532 );
				float3 Normal_XYZ260_g43202 = temp_output_38_0_g43202;
				int EnableDetailMask216_g43202 = _EnableDetailMask;
				int m_switch221_g43202 = EnableDetailMask216_g43202;
				float4 temp_output_1_0_g43203 = SAMPLE_TEXTURE2D( _DetailNormalMap, sampler_trilinear_repeat, texCoord67_g43202 );
				float temp_output_8_0_g43203 = _DetailNormalMapScale;
				float3 unpack52_g43203 = UnpackNormalScale( temp_output_1_0_g43203, temp_output_8_0_g43203 );
				unpack52_g43203.z = lerp( 1, unpack52_g43203.z, saturate(temp_output_8_0_g43203) );
				float3 Detail_Normal199_g43202 = unpack52_g43203;
				float3 m_Off221_g43202 = Detail_Normal199_g43202;
				float3 lerpResult205_g43202 = lerp( Normal_XYZ260_g43202 , Detail_Normal199_g43202 , temp_output_403_0_g43202);
				float3 m_Active221_g43202 = saturate( lerpResult205_g43202 );
				float3 lerpResult406_g43202 = lerp( Detail_Normal199_g43202 , Normal_XYZ260_g43202 , temp_output_403_21_g43202);
				float3 m_ActiveInverted221_g43202 = saturate( lerpResult406_g43202 );
				float3 localDetail_Maskfloat3switch221_g43202 = Detail_Maskfloat3switch221_g43202( m_switch221_g43202 , m_Off221_g43202 , m_Active221_g43202 , m_ActiveInverted221_g43202 );
				float3 Mask_Normal222_g43202 = localDetail_Maskfloat3switch221_g43202;
				float layeredBlendVar413_g43202 = DetailBlend43_g43202;
				float3 layeredBlend413_g43202 = ( lerp( Mask_Normal222_g43202,Normal_XYZ260_g43202 , layeredBlendVar413_g43202 ) );
				float3 normalizeResult414_g43202 = normalize( layeredBlend413_g43202 );
				float3 temp_output_416_0_g43202 = BlendNormal( normalizeResult414_g43202 , Normal_XYZ260_g43202 );
				float EnebleMode122_g43202 = _EnableDetailMap;
				float3 lerpResult410_g43202 = lerp( Normal_XYZ260_g43202 , temp_output_416_0_g43202 , EnebleMode122_g43202);
				...
				float3 Albedo = lerpResult409_g43202.xyz;
				float3 Normal = lerpResult410_g43202;
				float3 Emission = 0;
				float3 Specular = 0.5;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 appendResult132_g43202 = (float2(_DetailTilingXDetail , _DetailTilingYDetail));
				float2 appendResult114_g43202 = (float2(_DetailOffsetXDetail , _DetailOffsetYDetail));
				float2 texCoord67_g43202 = IN.ase_texcoord2.xy * appendResult132_g43202 + appendResult114_g43202;
				float4 tex2DNode45_g43202 = SAMPLE_TEXTURE2D( _DetailAlbedoMap, sampler_trilinear_repeat, texCoord67_g43202 );
				float4 ALBEDO_OUT255_g43202 = ( _ColorDetail * tex2DNode45_g43202 * _Brightness );
				float4 m_Off226_g43202 = ALBEDO_OUT255_g43202;
				float2 appendResult219_g43202 = (float2(_DetailTilingXDetailMask , _DetailTilingYDetailMask));
				float2 appendResult206_g43202 = (float2(_DetailOffsetXDetailMask , _DetailOffsetYDetailMask));
				float2 texCoord220_g43202 = IN.ase_texcoord2.xy * appendResult219_g43202 + appendResult206_g43202;
				float temp_output_15_0_g43205 = ( 1.0 - SAMPLE_TEXTURE2D( _DetailMaskMap, sampler_trilinear_repeat, texCoord220_g43202 ).r );
				float temp_output_26_0_g43205 = _Detail_BlendAmountMask;
				float temp_output_24_0_g43205 = _Detail_BlendHardnessMask;
				float saferPower2_g43205 = abs( max( saturate( (0.0 + (temp_output_15_0_g43205 - ( 1.0 - temp_output_26_0_g43205 )) * (temp_output_24_0_g43205 - 0.0) / (1.0 - ( 1.0 - temp_output_26_0_g43205 ))) ) , 0.0 ) );
...
/*ASEBEGIN
Version=18923
97;102.5;1730;798;-580.4141;1237.18;1;True;False
Node;AmplifyShaderEditor.CommentaryNode;388;1378.537,-381.1953;Inherit;False;294.6667;112;DESF Common ASE Compile Shaders;1;389;;0,0.2047877,1,1;0;0
...
Node;AmplifyShaderEditor.FunctionNode;390;705.4534,-683.196;Inherit;False;DESF Core Surface;9;;38532;c3df20d62907cd04086a1eacc41e29d1;18,1352,2,183,2,1382,1,1433,1,1432,1,1434,1,1638,0,1491,0,1588,0,1284,0,1446,0,1319,0,249,0,1318,0,1443,0,1337,0,1336,0,1407,0;2;309;FLOAT3;0,0,0;False;1262;FLOAT4;0,0,0,0;False;8;FLOAT4;42;FLOAT3;39;FLOAT;0;FLOAT4;41;COLOR;43;FLOAT;55;FLOAT;1624;FLOAT3;313
...
Node;AmplifyShaderEditor.FunctionNode;389;1388.537,-343.1953;Inherit;False;DESF Utility ASE Compile Shaders;-1;;43206;b85b01c42ba8a8a448b731b68fc0dbd9;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;387;1152.067,-679.7551;Inherit;False;DESF Module Detail;63;;43202;49c077198be2bdb409ab6ad879c0ca28;4,201,1,200,1,347,0,346,0;2;39;FLOAT4;0,0,0,0;False;38;FLOAT3;0,0,1;False;2;FLOAT4;73;FLOAT3;72
Node;AmplifyShaderEditor.IntNode;379;1402.969,-1010.118;Inherit;False;Property;_CullMode;Cull Mode;3;2;[Header];[Enum];Create;False;1;GLOBAL SETTINGS;0;1;UnityEngine.Rendering.CullMode;True;0;False;0;0;False;0;1;INT;0
Node;AmplifyShaderEditor.FunctionNode;402;1404.896,-924.1499;Inherit;False;DESF URP GUI 10x Surface Options;4;;43207;06c8ac62791f7a845bbafd8ecdb1912b;0;0;1;FLOAT;0
...
WireConnection;374;6;390;55
WireConnection;374;16;390;1624
ASEEND*/
//CHKSM=41F5A417E74D6A45DE2D479BBE622D3FB2715B24